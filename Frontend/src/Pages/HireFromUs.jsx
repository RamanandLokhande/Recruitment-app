...
export default function HireFromUs() {
  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      {/* Hero */}
      <section className="bg-blue-50 py-16 px-6 text-center" data-aos="fade-up">
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-blue-700 mb-12" data-aos="zoom-in">
          Why Hire from NextIntern?
        </h2>
      ...
      {/* CTA */}
      <section className="bg-blue-600 text-white py-16 text-center" data-aos="fade-in">
